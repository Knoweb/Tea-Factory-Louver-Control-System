    ...
    <Card className="w-full">
      <CardHeader className="pb-3 sm:pb-6">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-base sm:text-lg">Tea Factory Relative Humidity Control</CardTitle>
        </div>
        <CardDescription className="text-xs sm:text-sm">
          Relative humidity and depression monitoring for tea leaf processing quality
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ChartContainer
        ...
        <div className="mt-3 sm:mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 text-xs sm:text-sm">
          ...
          <div className="flex items-center gap-2 p-2 sm:p-3 bg-amber-50 rounded-lg border border-amber-200 sm:col-span-2 lg:col-span-1">
            ...
            <span className="text-amber-800">Quality tea zone</span>
          </div>
        </div>
      </CardContent>
    </Card>
